...
def responses(question: str):
    ...
    answer = ['Ok, I have no opinion on any of your trivial questions. Next!', 'Ok, please ask me a real question. I will not be answering otherwise.', 'Ok, do not waste my precious time with your gibberish.', 'Ok, you are absolutely unfunny.', 'Ok, I am a bit iffy on these types of questions. I will therefore not be answering them.']
    ...
    if question.lower().startswith('is') or question.lower().startswith('does') or question.lower().startswith('do i') or question.lower().startswith('do we') or question.lower().startswith('did it'):
        ...
        answer = ['Ok, I can say yes without a doubt.', 'Ok, I can say no without a doubt.', 'Ok... Well, no, unfortunately.', 'Ok... Well, yes, unfortunately.', 'Ok, I raise you a better question... Are you stupid?', 'Ok, the universe has decided so.', 'Ok, I say this with the utmost certainty... Yes.', 'Ok, I say this with the utmost certainty... No.']
