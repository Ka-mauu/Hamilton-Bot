...
def responses(question: str):
    ...
    if question.lower().startswith('is') or question.lower().startswith('does') or question.lower().startswith('do i') or question.lower().startswith('do we') or question.lower().startswith('did'):
